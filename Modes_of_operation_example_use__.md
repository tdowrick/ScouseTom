...
For 'standard' time difference EIT, multiple data sets are measured at different points in time, before and after the introduction of some perturbation. This is the most common EIT data collection method, being used in the vast majority of successful experiments in the field \cite{some review paper?}.
