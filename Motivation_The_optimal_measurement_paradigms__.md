...
- Noise, frame rate and performance characeristics comparable to existing EIT systems. Fast neural EIT involves detecting small (<1%) changes in impedance, which requires stable current injection, with <0.1% noise, and voltage recording with accuracy of ~100nV.
